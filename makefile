...
deploy_service1:
	BOX_ENERGY_CALL_URL=http://localhost:5000/ JAEGER_ENDPOINT=http://192.168.99.100:14268/api/traces SPRING_APPLICATION_NAME=box-8080 SERVER_PORT=8080 BOX_POLYNOMES_COEFFICIENTS=1000-2000,10@1 BOX_REMOTE_CALLS=http://localhost:8081@80,http://localhost:8082@80 mvn spring-boot:run
